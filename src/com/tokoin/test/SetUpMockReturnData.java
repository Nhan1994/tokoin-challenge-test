...
public class SetUpMockReturnData {
	public static String USER_BY_ID = "[{\n" + 
			"    \"_id\": 1,\n" + 
	...
	public static String USER_BY_ID_54 = "[{\n" + 
			"    \"_id\": 54,\n" + 
			...
			"    \"role\": \"admin\"\n" + 
			"  }]";
	public static String USER_BY_ID_72 = "[{\n" + 
			"    \"_id\": 72,\n" + 
			...
			"    \"role\": \"end-user\"\n" + 
			"  }]";
	public static String TICKET_BY_ASSIGNEE_54 = "[{\n" + 
			...
			"    \"via\": \"web\"\n" + 
			"  }]"; 
	public static String TICKET_BY_SUBMITTER_54 = "[{\n" + 
	...
	public static String ORGANIZATION_ID_124 = "[{\n" + 
			"    \"_id\": 124,\n" + 
			...
			"    ]\n" + 
			"  }]";
	public static String ORGANIZATION_ID_116 = "[{\n" + 
			"    \"_id\": 116,\n" + 
	...
	public static String TICKET_BY_ORGANIZATION_124 = "[{\n" + 
